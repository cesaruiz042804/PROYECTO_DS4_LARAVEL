    ...
    <main>
        <div class="product-container">
            ...
            <div class="product-info">
                ...
                <p>
                    Fresca y deliciosa, nuestra combinación de <br> chocolate y menta es el equilibrio perfecto <br>entre lo cremoso y lo refrescante. El helado <br>de chocomenta está hecho con auténtico <br>extracto 
                    de menta y trozos crujientes de<br> chocolate oscuro, creando una experiencia <br>de sabor que te dejará con ganas de más.<br> Cada cucharada te 
                    envuelve en un<br> contraste único de frescura y dulzura, ideal<br> 
                    para los amantes de sabores vibrantes. <br>¡Déjate llevar por la irresistible fusión de <br>menta y chocolate!
